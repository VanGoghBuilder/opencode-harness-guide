...
**语言 / Language：** [简体中文](INDEX.zh-CN.md) | [English](INDEX.md)

这是中文版的完整浏览索引。当你知道自己要解决的问题，但不知道文件在哪里时，从这里开始。
...
- [02-project-context/templates/PROJECT-FACTS-CHECKLIST.md](02-project-context/templates/PROJECT-FACTS-CHECKLIST.md)（英文模板）

### 我想复用更好的请求模板

- [03-commands-and-prompts/README.zh-CN.md](03-commands-and-prompts/README.zh-CN.md)
- [03-commands-and-prompts/templates/PLAN-REQUEST.md](03-commands-and-prompts/templates/PLAN-REQUEST.md)（英文模板）
- [03-commands-and-prompts/templates/REVIEW-REQUEST.md](03-commands-and-prompts/templates/REVIEW-REQUEST.md)（英文模板）
- [03-commands-and-prompts/templates/COMMIT-REQUEST.md](03-commands-and-prompts/templates/COMMIT-REQUEST.md)（英文模板）
- [03-commands-and-prompts/templates/PR-REQUEST.md](03-commands-and-prompts/templates/PR-REQUEST.md)（英文模板）

### 我想判断技能或代理值不值得做

- [04-skills-and-agents/README.zh-CN.md](04-skills-and-agents/README.zh-CN.md)
- [04-skills-and-agents/templates/SPECIALIZATION-DECISION-CHECKLIST.md](04-skills-and-agents/templates/SPECIALIZATION-DECISION-CHECKLIST.md)（英文模板）
- [04-skills-and-agents/templates/skills/self-assessment/README.md](04-skills-and-agents/templates/skills/self-assessment/README.md)（英文模板说明）
- [04-skills-and-agents/templates/skills/self-assessment/SKILL.md](04-skills-and-agents/templates/skills/self-assessment/SKILL.md)（英文模板正文）
...
- [07-team-workflows/templates/TEAM-ONBOARDING-CHECKLIST.md](07-team-workflows/templates/TEAM-ONBOARDING-CHECKLIST.md)（英文模板）
...
- [04-skills-and-agents/templates/skills/self-assessment/SKILL.md](04-skills-and-agents/templates/skills/self-assessment/SKILL.md)
